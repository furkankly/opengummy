...
export const TypewriterEffect = ({
  ...
  return (
    <h1 className={cn("text-sm md:text-xl lg:text-2xl", className)}>
      {renderWords()}
      <motion.span
        initial={{
          opacity: 0,
        ...
        className={cn(
          "inline-block h-4 w-[4px] rounded-sm bg-orange-500 sm:h-6 xl:h-8",
          cursorClassName,
        )}
      ></motion.span>
    </h1>
  ...
  return (
    <div className={cn("my-6 flex space-x-1", className)}>
      ...
      <motion.span
        ...
        className={cn(
          "block h-4 w-[4px] rounded-sm bg-orange-500 sm:h-6 lg:h-8",
          cursorClassName,
        )}
      ></motion.span>
    </div>
